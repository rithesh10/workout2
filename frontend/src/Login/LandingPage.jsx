  ...
  return (
    <div className="min-h-screen w-screen overflow-x-hidden bg-black">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button 
                ...
                className="px-4 py-2 bg-white bg-gradient-to-r from-indigo-600 to-purple-700 hover:opacity-90 transition-all transform hover:scale-105 text-white rounded-lg "
              >
                Register
              </button>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute w-full bg-black shadow-lg">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button onClick={toggleLogin} className="block w-full  px-3 py-2 bg-gradient-to-r from-indigo-600 to-purple-700 hover:opacity-90 transition-all transform hover:scale-105 text-white">
                Login
              </button>
              <button onClick={toggleRegister} className="block w-full px-3 py-2 bg-gradient-to-r from-indigo-600 to-purple-700 hover:opacity-90 transition-all transform hover:scale-105 text-white">
                Register
              </button>
            </div>
          </div>
      ...
      <div className="relative w-full bg-black">
        <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-black to-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block text-white">Transform Your Body</span>
                <span className="py-2 block bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">Track Your Progress</span>
              </h1>
